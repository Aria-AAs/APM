"""A module that contains the EditItem class
"""
...
class EditItem(QWidget):
    """A class that run edit item window of the password manager application."""
    ...
    def setup_ui(self) -> None:
        ...
        self.add_pushbutton = QPushButton("Done", self)
        self.add_pushbutton.clicked.connect(self.done_edit_item)
